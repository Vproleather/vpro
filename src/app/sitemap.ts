...
const baseUrl = new URL("https://www.vprousa.com");
...
const staticRoutes: Array<{
  ...
  { path: "/locations/baker-elementary-school", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/holly-springs-town-center", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/kennesaw-mountain", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/gibbs-gardens", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/noonday-creek-park", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/town-center-at-cobb", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/kennesaw-state-university", changeFrequency: "monthly", priority: 0.7 },
  { path: "/locations/woofstock-park", changeFrequency: "monthly", priority: 0.7 },
